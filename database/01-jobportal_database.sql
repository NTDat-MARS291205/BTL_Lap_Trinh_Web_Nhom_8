...
CREATE TABLE `job_post_activity` (
  ...
  `certificate_required` varchar(255) DEFAULT NULL,
...
CREATE TABLE `job_seeker_save` (
  ...
  CONSTRAINT `FKpb44x040gkdltxqy9m7jmvvf3` FOREIGN KEY (`job`) REFERENCES `job_post_activity` (`job_post_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
DROP FOREIGN KEY FKmfhx9q4uclbb74vm49lv9dmf4;

-- THÊM LẠI FK MỚI CÓ CASCADE
ALTER TABLE job_seeker_apply
ADD CONSTRAINT FKmfhx9q4uclbb74vm49lv9dmf4
FOREIGN KEY (job) REFERENCES job_post_activity(job_post_id)
ON DELETE CASCADE;


ALTER TABLE job_seeker_save
DROP FOREIGN KEY FKpb44x040gkdltxqy9m7jmvvf3;

ALTER TABLE job_seeker_save
ADD CONSTRAINT FKpb44x040gkdltxqy9m7jmvvf3
FOREIGN KEY (job) REFERENCES job_post_activity(job_post_id)
ON DELETE CASCADE;
